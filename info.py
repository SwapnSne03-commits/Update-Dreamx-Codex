...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003878655942 -1003702769501")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002612579654 -1003834489775")# Channels for force sub (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003834489775'))  # Notification of sent to your channel
...
LANDSCAPE_POSTER = bool(environ.get('LANDSCAPE_POSTER', False)) # Show landscape poster in notification msg
USE_LANDSCAPE_POSTER = os.environ.get("USE_LANDSCAPE_POSTER", "False").lower() == "true" #Show Landscape/Potrait Poster in search 
# ============================
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/yours_swap_bot') # Owner link for the bot
